...
void DesertLandBuilder::initializeTiles(){

	for (int i = 0; i < 14; i++){
		if(!tile[i].loadFromFile("tiles.png", IntRect(i * 32, 64, 32, 32))) tile[i].create(32,32);
	}
}
void DesertLandBuilder::putCommon(int *i, int *j, int *maptile){
...
void DesertLandBuilder::putRock(int *i, int *j, int *maptile){
...
void DesertLandBuilder::putSpecial(int *i, int *j, int *maptile){
